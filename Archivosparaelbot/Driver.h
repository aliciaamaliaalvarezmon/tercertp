...
class Driver {
	...
	/* Destruye el contenido del juego, liberando la memoria dinÃƒÂ¡mica alocada. */
	~Driver();
	 ...
	 * Esta funciÃƒÂ³n deberÃƒÂ¡ cambiar su aridad respecto del TAD devolviendo: 
	...
	* Es requisito que en la coordenada pasada como parametro haya un pokemon. */
	 ...
	 * con el cuÃƒÂ¡l interactuar. AdemÃƒÂ¡s, pueden declarar todas las		   *
